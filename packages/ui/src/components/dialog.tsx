...
>(({ className, children, hideCloseButton, offset = 'top', ...props }, ref) => (
	<DialogPortal>
		<DialogOverlay />
		<DialogPrimitive.Content
			ref={ref}
			className={cn(
				'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=open]:slide-in-from-left-1/2 fixed left-[50%] z-50 grid w-full max-w-[40rem] translate-x-[-50%] gap-4 border border-neutral-200 bg-white p-6 shadow-lg outline-none duration-200 sm:rounded-xl dark:border-neutral-800 dark:bg-neutral-950',
				offset === 'top' && 'top-[86px]',
				offset === 'center' &&
					'data-[state=open]:slide-in-from-top-[50%] data-[state=closed]:slide-out-to-top-[50%] top-[50%] translate-y-[-50%]',
				className,
			)}
			onEscapeKeyDown={(e) => {
